...
EURECA_CONF_FILE_PATH=$CONF_FILES_DIR_PATH/"eureca.conf"
...
EURECA_TABLES_DIR_PATTERN="tables"
EURECA_TABLES_DIR=$(grep $EURECA_TABLES_DIR_PATTERN $SERVICE_CONF_FILE_PATH | cut -d"=" -f2-)
...
echo "$EURECA_PORT_PATTERN=$EURECA_PORT" >> $PORTS_TAGS_CONF_FILE_PATH
...
echo "$EURECA_TAG_PATTERN=$EURECA_TAG" >> $PORTS_TAGS_CONF_FILE_PATH
...
EURECA_DIR_PATH="./tmp/conf-files/eureca"
EURECA_CONF_FILE_NAME="eureca.conf"
EURECA_CONTAINER_CONF_FILE_DIR_PATH="/root/eureca-backend/src/main/resources/private"
EURECA_PRIVATE_KEY_PATH=$EURECA_DIR_PATH/"id_rsa"
EURECA_PUBLIC_KEY_PATH=$EURECA_DIR_PATH/"id_rsa.pub"
EURECA_RSA_KEY_PATH=$EURECA_DIR_PATH/"rsa_key.pem"

## Creating directory
mkdir -p $EURECA_DIR_PATH
cp $EURECA_CONF_FILE_PATH $EURECA_DIR_PATH/$EURECA_CONF_FILE_NAME
chmod 600 $EURECA_DIR_PATH/$EURECA_CONF_FILE_NAME
...
openssl genrsa -out $EURECA_RSA_KEY_PATH 2048
openssl pkcs8 -topk8 -in $EURECA_RSA_KEY_PATH -out $EURECA_PRIVATE_KEY_PATH -nocrypt
openssl rsa -in $EURECA_PRIVATE_KEY_PATH -outform PEM -pubout -out $EURECA_PUBLIC_KEY_PATH
chmod 600 $EURECA_PRIVATE_KEY_PATH
rm $EURECA_RSA_KEY_PATH
echo "eureca_publickey="$EURECA_CONTAINER_CONF_FILE_DIR_PATH/"id_rsa.pub" >> $EURECA_DIR_PATH/$EURECA_CONF_FILE_NAME
echo "eureca_privatekey="$EURECA_CONTAINER_CONF_FILE_DIR_PATH/"id_rsa" >> $EURECA_DIR_PATH/$EURECA_CONF_FILE_NAME
