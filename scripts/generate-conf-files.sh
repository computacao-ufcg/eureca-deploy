...
BACKEND_CONF_FILE_PATH=$CONF_FILES_DIR_PATH/"eureca.conf"
...
BACKEND_CONF_FILE_NAME="eureca.conf"
...
sed -i "s|$HOST_FQDN_PATTERN|$HOST_FQDN|g" $FRONTEND_DIR_PATH/"api.js"
...
sed -i "s|$HOST_FQDN_PATTERN|$HOST_FQDN|g" $ALUMNI_SITE_DIR_PATH/"api.js"
...
sed -i "s|$BACKEND_PORT_PATTERN|$BACKEND_PORT|g" $APACHE_DIR_PATH/$APACHE_VHOST_FILE_NAME
sed -i "s|$ALUMNI_PORT_PATTERN|$ALUMNI_PORT|g" $APACHE_DIR_PATH/$APACHE_VHOST_FILE_NAME
sed -i "s|$FRONTEND_PORT_PATTERN|$FRONTEND_PORT|g" $APACHE_DIR_PATH/$APACHE_VHOST_FILE_NAME
sed -i "s|$ALUMNI_SITE_PORT_PATTERN|$ALUMNI_SITE_PORT|g" $APACHE_DIR_PATH/$APACHE_VHOST_FILE_NAME
